          ...
          >
            ...
            <div className="flex flex-col mt-8">
              ...
              <input
                ...
                className="border outline-0 focus:border-black text-black border-[#D5D7DA] mt-1.5 placeholder:text-text-7 rounded-md px-3.5 py-2"
              />
            </div>
            ...
            <div className="mt-6 flex flex-col gap-3">
              <div className="flex items-center gap-2">
                ...
                <p
                  className={`text-sm transition-colors duration-300 ${password.length >= 8 ? "text-text-1 font-medium" : "text-[#535862]"}`}
                >
              ...
              <div className="flex items-center gap-2">
                ...
                <p
                  className={`text-sm transition-colors duration-300 ${/[!@#$%^&*(),.?":{}|<>]/.test(password) ? "text-text-1 font-medium" : "text-[#535862]"}`}
                >
            ...
            <button
              onClick={() => router.push("/Account/PasswordReset")}
