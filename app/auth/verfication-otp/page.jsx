        ...
        <div className="m-auto w-full max-w-90">
          ...
          >
            ...
            <div className="mt-8">
              ...
              <button className="text-[var(--color-main)] flex items-center justify-center w-full gap-1.5 hover:text-[var(--color-main)]/85 transition text-sm font-semibold cursor-pointer">
                Click here to send it again.
              </button>
            </div>
            <p className="text-sm text-[#FF0000]">Resend code in 30s</p>
            <button
              onClick={() => router.push("/Account/SetNewPassword")}
