                                ...
                                <Form>
                                    ...
                                    <div className='flex flex-col mt-5'>
                                        <label htmlFor="password"
                                            className='text-[#414651] text-xs md:text-sm font-medium '>Email<span className='text-[#FF383C]'>*</span></label>
                                        <Field
                                            name="email"
                                            type="email"
                                    ...
                                    <div className='flex w-full justify-between mt-8'>
                                        <button type='button' className='text-[var(--color-main)] flex items-center justify-center w-full gap-1.5 hover:text-[var(--color-main)]/85 transition text-sm font-semibold cursor-pointer' onClick={() => router.push("/auth/login")}>
