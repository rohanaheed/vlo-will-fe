    ...
    <div className="text-black">
      <div className="flex items-center max-sm:flex-col max-sm:items-start max-sm:gap-4 justify-between mt-7.5 ">
        ...
        <div className="flex max-sm:justify-end items-center gap-2 max-sm:self-end flex-wrap">
          <div className="group flex items-center gap-2 border border-[#D5D7DA] p-2.25 px-4 rounded-lg cursor-pointer hover:bg-main hover:text-white transition-all">
            <Image
              src={CustomizeIcon}
              alt="customize"
              width={20}
            ...
            />
            <p className="text-sm font-semibold text-black group-hover:text-white transition-all">
              Customize
            </p>
          </div>
          ...
          <div className="group max-sm:self-end border border-[#D5D7DA] p-1.75 rounded-lg cursor-pointer hover:bg-main hover:text-white transition-all">
            <Image
              ...
              width={24}
              height={24}
              className="min-w-6 group-hover:brightness-0 group-hover:invert transition-all"
            />
          </div>
