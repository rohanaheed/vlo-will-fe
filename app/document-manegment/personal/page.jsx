...
const Personal = () => {
  ...
  const [activeSubTab, setActiveSubTab] = useState("Personal Matters");
  const [statusTab, setStatusTab] = useState("All");
  const [selectedLetter, setSelectedLetter] = useState("A");

  const subTabs = [
    { name: "Personal Matters", count: 3 },
    { name: "Wills & Estate Planning", count: 7 },
    { name: "Finance & Transactions", count: 6 },
    { name: "Intellectual Property & Privacy", count: 6 },
    { name: "Legal Support", count: 4 },
  ];
  ...
  return (
    <div className="p-4">
      ...
      <div className="flex items-center border-b border-black/16 gap-6 mb-4 ">
