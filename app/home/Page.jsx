...
function Page() {
    ...
    const sliderContent = [
        {
            image: SliderBg1,
            quote: "I needed a tenancy agreement urgently and late at night. The process was straightforward, and I had a professional document ready in minutes.",
        ...
        {
            image: SliderBg1,
            quote: "As a small business owner, I can't always afford a solicitor. this platform gives me peace of mind with lawyer-approved templates.",
            author: "Michael Chen",
        ...
        {
            image: SliderBg1,
            quote: "Incredible service! The guided questionnaire made sure I didn't miss any important details in my will. Highly recommended.",
    ...
    return (
        <>
            <div className='max-w-[1200px] mx-auto bg-white'>
                <UserHeader />
                <div className="bg-[url('@/components/assets/images/Background.svg')] max-lg:flex flex-col-reverse lg:grid grid-cols-[1fr_560px] gap-8 p-4 pt-20 md:pt-30 pb-18 md:pb-24 bg-cover bg-center">
                    <div className=''>
                        ...
                        <div className='flex items-center flex-wrap gap-2 mt-3'>
                            <button onClick={() => setButton("property")} className={`rounded-lg p-2.75 max-md:w-full border hover:border-main focus:border-main transition-all duration-300 cursor-pointer ${button === "property" ? "bg-[#ECF6FF] text-main border-main" : "border-black/16 hover:bg-[#ECF6FF] bg-white hover:text-main text-text-7"}`}>Property & Tenancy</button>
                            <button onClick={() => setButton("business")} className={`rounded-lg p-2.75 max-md:w-full border hover:border-main focus:border-main transition-all duration-300 cursor-pointer ${button === "business" ? "bg-[#ECF6FF] text-main border-main" : "border-black/16 hover:bg-[#ECF6FF] bg-white hover:text-main text-text-7"}`}>Business & Services</button>
                            <button onClick={() => setButton("employment")} className={`rounded-lg p-2.75 max-md:w-full border hover:border-main focus:border-main transition-all duration-300 cursor-pointer ${button === "employment" ? "bg-[#ECF6FF] text-main border-main" : "border-black/16 hover:bg-[#ECF6FF] bg-white hover:text-main text-text-7"}`}>Employment & HR</button>
                            <button onClick={() => setButton("personal")} className={`rounded-lg p-2.75 max-md:w-full border hover:border-main focus:border-main transition-all duration-300 cursor-pointer ${button === "personal" ? "bg-[#ECF6FF] text-main border-main" : "border-black/16 hover:bg-[#ECF6FF] bg-white hover:text-main text-text-7"}`}>Personal & Family</button>
                            <button onClick={() => setButton("finance")} className={`rounded-lg p-2.75 max-md:w-full border hover:border-main focus:border-main transition-all duration-300 cursor-pointer ${button === "finance" ? "bg-[#ECF6FF] text-main border-main" : "border-black/16 hover:bg-[#ECF6FF] bg-white hover:text-main text-text-7"}`}>Finance & Loans</button>
                            <button onClick={() => setButton("legal")} className={`rounded-lg p-2.75 max-md:w-full border hover:border-main focus:border-main transition-all duration-300 cursor-pointer ${button === "legal" ? "bg-[#ECF6FF] text-main border-main" : "border-black/16 hover:bg-[#ECF6FF] bg-white hover:text-main text-text-7"}`}>Legal & Compliance</button>
                            <button onClick={() => setButton("more")} className={`rounded-lg p-2.75 max-md:w-full border hover:border-main focus:border-main transition-all duration-300 cursor-pointer ${button === "more" ? "bg-[#ECF6FF] text-main border-main" : "border-black/16 hover:bg-[#ECF6FF] bg-white hover:text-main text-text-7"}`}>More</button>

                        </div>
                    </div>
                    <div className=''>
                        <Image src={video} alt="video" width={100} height={100} className='w-full h-full' />
                    </div>
                </div>
                <div className='px-4 py-18 md:py-24 bg-white grid min-[1000px]:grid-cols-[30%_69%] grid-cols-1 gap-4'>
                    <div className=''>
                    ...
                    <div className='mt-16 grid grid-cols-1 md:grid-cols-2 gap-8'>
                        <div>
                            <div className=' px-6 py-4 border-l-4 border-[#587C9F]'>
                                <h1 className='text-xl font-semibold text-text-1'>Step 1 — Pick the document</h1>
                                <p className='text-base font-normal text-text-5 mt-2'>Complete a short guided form. We use your answers to populate the document automatically.</p>
                            </div>
                            <div className=' px-6 py-4 border-l-4 border-[#F5F5F5]'>
                                <h1 className='text-xl font-semibold text-text-1'>Step 2 — Answer a few questions</h1>
                                <p className='text-base font-normal text-text-5 mt-2'>Search or browse our library of templates (wills, tenancy, contracts, business forms).</p>
                            </div>
                            <div className=' px-6 py-4 border-l-4 border-[#F5F5F5]'>
                                <h1 className='text-xl font-semibold text-text-1'>Step 3 — Customise & review</h1>
                                <p className='text-base font-normal text-text-5 mt-2'>Make edits add clauses or request a legal review. Documents are downloadable in Word or PDF.</p>
                            </div>
                            <div className=' px-6 py-4 border-l-4 border-[#F5F5F5]'>
                                <h1 className='text-xl font-semibold text-text-1'>Step 4 — Save, sign or share</h1>
                                <p className='text-base font-normal text-text-5 mt-2'>Save your document to your account, print or share a secure link. Use e-signatures where available.</p>
                            </div>
                        </div>
                        <div className='bg-[#F5F5F5] p-6'>
                            <Image src={docIcon} alt="docIcon" width={100} height={100} className='min-w-full min-h-full object-cover object-left' />
                        </div>
                    </div>

                </div>
                <div className='px-4'>
                    <h1 className='text-[36px] font-semibold text-text-1 mt-5'>What Do You Want to Accomplish Today?</h1>
                    <p className='text-xl font-normal text-text-5 mt-5'>
                        Select an option to get tailored legal forms and guidance in just a few minutes.
                    </p>
                </div>
                <div className='px-4'>
                    <div className='flex p-0.75 bg-[#FAFAFA] rounded-xl border border-black/16 mt-8'>
                        <button className={`${tab === "personal" ? "bg-main text-white" : "bg-white text-text-1"} p-2.5 rounded-xl w-full cursor-pointer transition-all duration-300`} onClick={() => setTab("personal")}>Personal</button>
                        <button className={`${tab === "corporate" ? "bg-main text-white" : "bg-white text-text-1"} p-2.5 rounded-xl w-full cursor-pointer transition-all duration-300`} onClick={() => setTab("corporate")}>Corporate</button>
                    </div>
                </div>
                {tab === "personal" && <PersonalPage />}
                {tab === "corporate" && <Corporate />}

                <div className='grid grid-cols-1 md:grid-cols-2 pt-18 md:pt-24 items-center gap-8 p-4'>
                    <div>
                        <h1 className=' text-xl md:text-[36px] lg:text-[48px] font-semibold text-text-1'>Why choose DocNet?</h1>
                        <div>
                            <div className='flex items-center gap-2 mt-8'>
                                <div className='bg-[#ECF6FF] rounded-full p-2'>
                                    <Image src={checkIcon} alt="checkIcon" width={14} height={14} className='w-3.5 h-3.5' />
                                </div>
                                <p className='text-lg font-normal text-text-5 mt-2'><span className='font-bold'>Reliable —</span> All documents are built to meet legal standards.</p>
                            </div>
                            <div className='flex items-center gap-2 mt-5'>
                                <div className='bg-[#ECF6FF] rounded-full p-2'>
                                    <Image src={checkIcon} alt="checkIcon" width={14} height={14} className='w-3.5 h-3.5' />
                                </div>
                                <p className='text-lg font-normal text-text-5 mt-2'><span className='font-bold'>Affordable —</span> No hourly fees or appointments required.</p>
                            </div>
                            <div className='flex items-center gap-2 mt-5'>
                                <div className='bg-[#ECF6FF] rounded-full p-2'>
                                    <Image src={checkIcon} alt="checkIcon" width={14} height={14} className='w-3.5 h-3.5' />
                                </div>
                                <p className='text-lg font-normal text-text-5 mt-2'><span className='font-bold'>Fast —</span> Create and download your document in less than 10 minutes.</p>
                            </div>
                            <div className='flex items-center gap-2 mt-5'>
                                <div className='bg-[#ECF6FF] rounded-full p-2'>
                                    <Image src={checkIcon} alt="checkIcon" width={14} height={14} className='w-3.5 h-3.5' />
                                </div>
                                <p className='text-lg font-normal text-text-5 mt-2'><span className='font-bold'>Accessible —</span> Available online 24/7 from any device.</p>
                            </div>
                            <div className='flex items-center gap-2 mt-5'>
                                <div className='bg-[#ECF6FF] rounded-full p-2'>
                                    <Image src={checkIcon} alt="checkIcon" width={14} height={14} className='w-3.5 h-3.5' />
                                </div>
                                <p className='text-lg font-normal text-text-5 mt-2'><span className='font-bold'>Supportive —</span> Our friendly team is always ready to help.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className='bg-main text-center pt-18 md:pt-24 pb-40'>
                            ...
                            <div className="bg-cover bg-center bg-no-repeat p-4">
                                <div>
                                    ...
                                    <h2 className='text-xl text-white'>Legal documents created</h2>
