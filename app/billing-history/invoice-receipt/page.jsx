...
import ShareInvoicePopup from "@/components/layout/Modal/ShareInvoicePopup";
  ...
  return (
    <div className="h-screen">
      ...
      <div className="min-h-[calc(100vh-64px)]">
              ...
              <div className="">
                ...
                <div className="flex flex-col md:flex-row items-center flex-wrap whitespace-nowrap gap-2 mt-4">
                  ...
                  <button
                    ...
                    className="bg-main text-white border-main group flex items-center font-semibold justify-center gap-2 px-4 py-2.5 border-2 rounded-lg transition-colors cursor-pointer w-full md:max-w-[150px] md:shrink md:grow md:basis-[120px]"
                  >
                    <Image
                      src={EditIconBlue}
                      alt="Edit"
        ...
        <div className="border-b max-w-[1200px] mx-auto max-[1200px]:px-4 border-black/16 md:pb-16 pb-8 lg:pb-24">
          <div className="max-w-[900px] mx-auto px-4 md:mt-16 mtb-8 lg:mt-24 ">
              ...
              <div className="grid sm:grid-cols-2 grid-cols-1 gap-4 mb-3">
                <div>
                  ...
                  <div className="text-sm text-black space-y-1">
                    ...
                    <p className="text-xs text-black">
                      <span className="font-semibold">Phone:</span> +44 789
                      123456
                    </p>
                    <p className="text-xs text-black">
      ...
      <SuccessPopup
        ...
        heading="Invoice Shared Successfully"
        description="Your invoice has been shared with the selected recipients."
        button="Closed"
      />
    </div>
  );
