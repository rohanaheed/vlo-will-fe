...
function Dashboard() {
  ...
  const [subscriptionRevenuebutton, setSubscriptionRevenuebutton] =
    useState("Yearly");
    ...
    <div className="mt-16 md:mt-22 pb-3 md:pb-6 text-black">
      ...
      <main className="lg:max-w-[calc-(100%-300px)] lg:ml-80.5 m-3 mb-0 md:m-6 md:mb-0 bg-white p-3 md:p-6 rounded-md border border-[#E6E6E6]">
        <div>
          ...
          <p className="text-base text-[#7C8DB5]">
            Here is the information about all your Super Admin
          </p>
        </div>
        ...
        <div className="bg-[#ECF6FF] rounded-lg p-4 border border-[#ECF6FF] mt-6">
          ...
          <div className="mt-4 flex flex-wrap gap-2 whitespace-nowrap">
            <button className="text-sm max-md:w-full flex items-center gap-2 text-white bg-main hover:bg-main/90 transition-all duration-200 rounded-lg px-3.5 py-2.5 cursor-pointer">
              <p className="text-lg leading-none -mt-0.5">+</p>{" "}
              <p>Create Subscription Package</p>
            </button>
            <button className="text-sm max-md:w-full flex items-center gap-2 text-white bg-main hover:bg-main/90 transition-all duration-200 rounded-lg px-3.5 py-2.5 cursor-pointer">
              <p className="text-lg leading-none -mt-0.5">+</p>{" "}
              <p>Add Document</p>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="border border-black/16 rounded-lg p-4 bg-[#FAFAFA]">
            <div className="flex items-center gap-2 justify-between flex-wrap">
              <CommonDropdown
                ...
                className="!border-none !bg-transparent !p-0 !w-fit"
              ...
              <div className="overflow-x-auto scrollbar-thin">
                <div className="flex items-center w-fit border border-[#D5D7DA] rounded-[11px] whitespace-nowrap">
                  <button
                    ...
                    className={`${growthbutton === "Yearly" ? "bg-white text-text-4 border-[#D5D7DA]" : "text-text-7 border-transparent"} rounded-[9px] p-2 font-bold border text-sm cursor-pointer`}
                  >
                    Yearly
                  </button>
                  <button
                    onClick={() => setGrowthbutton("Quarterly")}
                    className={`${growthbutton === "Quarterly" ? "bg-white text-text-4 border-[#D5D7DA]" : "text-text-7 border-transparent"} rounded-[9px] p-2 font-bold border text-sm cursor-pointer`}
                  >
                    Quarterly
                  </button>
                  <button
                    onClick={() => setGrowthbutton("Monthly")}
                    className={`${growthbutton === "Monthly" ? "bg-white text-text-4 border-[#D5D7DA]" : "text-text-7 border-transparent"} rounded-[9px] p-2 font-bold border text-sm cursor-pointer`}
                  >
                    Monthly
                  </button>
                  <button
                    onClick={() => setGrowthbutton("Weekly")}
                    className={`${growthbutton === "Weekly" ? "bg-white text-text-4 border-[#D5D7DA]" : "text-text-7 border-transparent"} rounded-[9px] p-2 font-bold border text-sm cursor-pointer`}
                  >
                    Weekly
                  </button>
                  <button
                    onClick={() => setGrowthbutton("24 hours")}
                    className={`${growthbutton === "24 hours" ? "bg-white text-text-4 border-[#D5D7DA]" : "text-text-7 border-transparent"} rounded-[9px] p-2 font-bold border text-sm cursor-pointer`}
                  >
                    24 hours
                  </button>
                </div>
              ...
              <div className="flex justify-between md:items-start items-center gap-2">
                <div>
                  <h1 className="sm:text-xl lg:text-[30px] font-semibold">
          ...
          <div className="border border-black/16 rounded-lg p-4 bg-[#FAFAFA]">
            <div className="flex items-center gap-2 justify-between flex-wrap">
              <CommonDropdown
                options={subscriptionRevenueOptions}
                value={subscriptionRevenue}
                onChange={setSubscriptionRevenue}
              ...
              <div className="overflow-x-auto scrollbar-thin">
                <div className="flex items-center w-fit border border-[#D5D7DA] rounded-[11px] whitespace-nowrap">
                  <button
                    ...
                    className={`${subscriptionRevenuebutton === "Yearly" ? "bg-white text-text-4 border-[#D5D7DA]" : "text-text-7 border-transparent"} rounded-[9px] p-2 font-bold border text-sm cursor-pointer`}
                  >
                    Yearly
                  </button>
                  <button
                    onClick={() => setSubscriptionRevenuebutton("Quarterly")}
                    className={`${subscriptionRevenuebutton === "Quarterly" ? "bg-white text-text-4 border-[#D5D7DA]" : "text-text-7 border-transparent"} rounded-[9px] p-2 font-bold border text-sm cursor-pointer`}
                  >
                    Quarterly
                  </button>
                  <button
                    onClick={() => setSubscriptionRevenuebutton("Monthly")}
                    className={`${subscriptionRevenuebutton === "Monthly" ? "bg-white text-text-4 border-[#D5D7DA]" : "text-text-7 border-transparent"} rounded-[9px] p-2 font-bold border text-sm cursor-pointer`}
                  >
                    Monthly
                  </button>
                  <button
                    onClick={() => setSubscriptionRevenuebutton("Weekly")}
                    className={`${subscriptionRevenuebutton === "Weekly" ? "bg-white text-text-4 border-[#D5D7DA]" : "text-text-7 border-transparent"} rounded-[9px] p-2 font-bold border text-sm cursor-pointer`}
                  >
                    Weekly
                  </button>
                  <button
                    onClick={() => setSubscriptionRevenuebutton("24 hours")}
                    className={`${subscriptionRevenuebutton === "24 hours" ? "bg-white text-text-4 border-[#D5D7DA]" : "text-text-7 border-transparent"} rounded-[9px] p-2 font-bold border text-sm cursor-pointer`}
                  >
                    24 hours
                  </button>
                </div>
        ...
        <div className="border mt-6 border-black/16 rounded-lg p-4 bg-[#FAFAFA]">
          <div className="flex items-center mb-5 pb-5 border-b border-black/16 justify-between">
            <h1 className="md:text-lg font-semibold text-text-1">
              Active users right now
            </h1>
            <button className="text-text-4 hover:bg-zinc-100 text-sm font-semibold border border-[#D5D7DA] rounded-md p-2 cursor-pointer">
              Real-time report
            </button>
          </div>
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
            ...
            <div>
              <h1 className="text-lg text-text-1 font-semibold text-xl md:text-[36px]">
                10.8k
              </h1>
                ...
                {countryData.map((item, index) => (
                  <div key={index} className="flex gap-3 w-full">
                    ...
                    <div className="flex flex-col gap-2 w-full">
                      <p className="text-sm font-medium text-text-4">
                        {item.name}
                      </p>
                      <div className="flex items-center gap-3 w-full">
                        ...
                        <p className="text-sm font-medium text-text-4 min-w-[30px] text-right">
                          {item.percentage}%
                        </p>
                      </div>
                    </div>
