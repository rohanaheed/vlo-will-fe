                ...
                <div className='m-auto w-full max-w-90'>
                    <form action="" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div className='flex flex-col mt-8'>
                            ...
                            <input type='text' value={email} onChange={(e) => setEmail(e.target.value)} id='email' placeholder='Enter your email' className='shadow border outline-0 focus:border-black text-black border-[#D5D7DA] mt-1.5 placeholder:text-[#717680] rounded-md px-3.5 py-2' />
                        </div>
                        <div className='flex flex-col mt-5'>
                            ...
                            <input type='password' value={password} onChange={(e) => setPassword(e.target.value)} id='password' placeholder='Enter your password' className='shadow border outline-0 focus:border-black text-black border-[#D5D7DA] mt-1.5 placeholder:text-[#717680] rounded-md px-3.5 py-2' />
                        </div>
                        <div className='flex flex-col sm:gap-2 sm:flex-row justify-between mt-8'>
                            <div className='flex items-center gap-0.5'>
                                <input type="checkbox" id='check' className='cursor-pointer' />
                                <label htmlFor="check" className=' cursor-pointer text-[#414651] text-sm font-medium mt-0.25'>Remember me for 30 days</label>
                            </div>
                            <button className='text-[var(--color-main)] hover:text-[var(--color-main)]/85 transition text-sm font-semibold cursor-pointer self-end' onClick={() => router.push("/Account/ForgetPassword")}>
                                Forgot password
                            </button>
                        </div>
                        <button className='bg-[var(--color-main)] hover:bg-[var(--color-main)]/85 transition cursor-pointer w-full mt-8 font-semibold text-white border-2 border-[var(--color-main)] rounded-lg p-2.5'>
                            Sign in
                        </button>
                        ...
                        <div className='flex items-center justify-center gap-2 mt-4'>
                            ...
                            <button className='text-[var(--color-main)] hover:text-[var(--color-main)]/85 transition text-sm font-semibold cursor-pointer' onClick={() => router.push("/Account/signup")}>
                                Sign up
                            </button>
                        </div>
                    </form>
