                ...
                <div className='m-auto w-full max-w-90'>
                    <form action="" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div className='flex flex-col mt-8'>
                            ...
                            <input type='text' value={email} onChange={(e) => setEmail(e.target.value)} id='email' placeholder='Enter your email' className='border outline-0 focus:border-black text-black border-[#D5D7DA] mt-1.5 placeholder:text-[#717680] rounded-md px-3.5 py-2' />
                        </div>
