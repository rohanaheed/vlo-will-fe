  ...
  return (
    <div className="relative">
      <div className="flex items-center max-md:flex-col gap-2 justify-between mb-6">
        <div className="flex max-sm:flex-col items-center gap-2">
          ...
          <div className="max-sm:self-start">
            <p className="font-semibold text-lg md:text-2xl text-[#1A2232]">
              Ahmed Khan
            </p>
            ...
            <div className="flex flex-wrap items-center gap-2 whitespace-nowrap w-full overflow-x-auto mt-1">
              <button className="text-main cursor-pointer border-r-main border-r pr-1.5 text-xs font-medium">
                Edit User
              </button>
              <button className="text-main cursor-pointer border-r-main border-r pr-1.5 text-xs font-medium">
                Suspend
              ...
              <button className="text-main cursor-pointer text-xs font-medium">
                Send Email
              </button>
            </div>
          </div>
        </div>
        <div className="group inline-flex self-end items-center gap-2 border border-(--color-main) p-2 sm:p-3 px-4 rounded-[10px] cursor-pointer hover:bg-main hover:text-white transition-colors">
          <Image
            src={logoutIcon}
            alt="customize"
            width={20}
      ...
      <div className="mb-2.5">
        <p className="text-base mb-2.5 text-[#33383F]">
          Licence Expires On: <span className="font-bold">12/07/2025</span>
        </p>
      ...
      <div className="grid grid-cols-1 gap-4 mb-6 text-sm">
        <div className="flex sm:items-center">
          ...
          <span className="text-[#33383F] font-bold">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="border flex items-center gap-1 border-black/16 text-[##414651] text-xs px-2 py-0.5 rounded-md font-medium shadow">
              <div className="w-1.5 inline-block h-1.5 rounded-full bg-[#17B26A]"></div>{" "}
              Paid
            </div>
          </div>
        </div>
      ...
      <div>
        <div className="bg-main text-white px-2.5 py-1.5 font-semibold md:text-xl text-base">
          ...
          <div className="grid grid-cols-1 gap-y-5 text-sm">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-[140px_1fr] items-start">
              ...
              <span className="text-[#1A1D1F]">
                Model45 Broadway High Street Uxbridge UB8 1LD
              </span>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-[140px_1fr] items-center">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-[140px_1fr] items-center">
              ...
              <span className="text-[#1A1D1F] flex items-center gap-1">
                <Image src={UkFlag} alt="UK" width={16} height={16} /> GBP (£)
              </span>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-[140px_1fr] items-center">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-[140px_1fr] items-center">
              ...
              <span className="bg-[#FF0000] text-white text-sm font-semibold px-5 py-1.5 rounded-full w-fit">
                Expired
              </span>
            </div>
          </div>
