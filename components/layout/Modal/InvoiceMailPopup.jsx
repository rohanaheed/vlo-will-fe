...
function InvoiceMailPopup({ onClose, onSave, onDelete }) {
    ...
    __html: `
      <div style="display: flex; gap: 8px; align-items: start;">
        ...
        <p style="margin: 0; font-size: 14px; color: #374151; line-height: 1.5;">
          We trust this email will find you well. Please find attached your invoice, and you can make the payment easily and securely by clicking on the Pay Now button. It will take you to Stripe where you can make payment through your bank card.
        </p>
      </div>
    `,
  });
        ...
        <div className="px-6 pb-6">
          ...
          <div className="flex flex-col gap-1.5 mb-5">
            ...
            <div className="flex items-center justify-between border border-black/16 rounded-[10px] p-3 py-3.25 cursor-pointer hover:bg-gray-50 transition-colors">
              <span className="text-sm text-text-1">Invoice send by email</span>
              <Image
...
export default InvoiceMailPopup;
