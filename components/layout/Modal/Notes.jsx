...
import del from "@/components/assets/images/deltext.svg";
...
import dot from "@/components/assets/images/dots.svg";
...
import Dropdown_2 from "@/components/assets/images/dropdown_2.svg";
...
function Notes({ onClose }) {
  ...
  const textRef = useRef(
    "Client prefers contact via WhatsApp in the evenings. Specializes in property disputes. Provided ID verification documents",
  );
  ...
  return (
    <div className="fixed inset-0 bg-black/20 backdrop-blur-lg flex justify-between items-center z-100">
      <div className="text-black w-full max-md:mx-4 md:max-w-[480px] mx-auto bg-white rounded-lg p-4 md:p-6">
        <div className="flex justify-between items-center mb-5">
          <h1 className="md:text-lg text-base font-semibold">Add Note</h1>
          <div className="cursor-pointer" onClick={onClose}>
            <Image src={CloseIcon} alt="close" width={20} height={20} />
          </div>
        </div>
        <div className="flex flex-col gap-1.5 mb-5">
          <label htmlFor="title" className="text-text-4 text-sm font-medium">
            Title
            <span className="text-[#FF383C] text-sm font-medium">*</span>
          </label>
          <input
            id="title"
            className="border text-text-7 border-black/16 p-2.5 rounded-lg"
        ...
        <div className="rounded-lg border border-black/16 shadow">
          ...
          <div className="p-4 flex gap-2">
            <div
              ...
              className="w-full outline-0 border-0 resize-none overflow-hidden min-h-[10px] [&_ol]:list-decimal [&_ul]:list-disc [&_ol]:pl-5 [&_ul]:pl-5 [&_img]:max-w-full"
            />
          </div>
        </div>
        <div className="flex gap-3 mt-8">
          ...
          <button
            onClick={onClose}
            className="w-full rounded-lg cursor-pointer bg-main hover:bg-main/85 text-white transition-all duration-300 border border-black/16 py-2.25 font-semibold"
          >
            Save Note
          </button>
        </div>
