    ...
    <div className="w-full">
      <div className="overflow-x-auto rounded-lg border border-[#EAECF0]">
        <table className="w-full min-w-max border-collapse">
          <thead>
            <tr className="bg-(--color-main) select-none text-white text-left">
              {selectable && (
                <th className="p-4 w-12 rounded-tl-lg relative flex justify-center items-center ">
                  <input
                    type="checkbox"
                    className="w-4 h-5 rounded border-gray-300 cursor-pointer accent-(--color-main)"
              ...
              {columns.map((col, idx) => (
                <th
                  ...
                  className={`p-4 text-[14px] font-semibold tracking-[-0.006em] text-left relative ${
                    idx === columns.length - 1 && !selectable
                      ? "rounded-tr-lg"
                      : ""
